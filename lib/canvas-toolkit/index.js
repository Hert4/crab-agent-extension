 ...
 * Entry point - Export all modules
 */
...
/**
 * CanvasToolkit - Main class combining all modules
 */
class CanvasToolkit {
  constructor() {
  ...
  /**
   * Initialize toolkit with tab ID
   */
  ...
  /**
   * Shortcut: Select tool and draw shape
   */
  ...
  /**
   * Shortcut: Click at position and type text
   */
  async clickAndType(x, y, text) {
    this._checkInitialized();

    await this.doubleClick(x, y); // Double click to focus text
    await this._sleep(100);
